all_data = [{:vm_name => "p-2-4-11-iMQL-3-backups-and-recovery-backup-server", :old_ip_addr => "172.22.6.255", :new_ip_addr => "10.170.92.3"},
...
#   old_ip_addr = data[:old_ip_addr]
#   new_ip_addr = data[:new_ip_addr]
# end
