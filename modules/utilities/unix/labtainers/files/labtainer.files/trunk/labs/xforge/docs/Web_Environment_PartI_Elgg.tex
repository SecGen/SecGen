...
This lab includes four networked computers as shown in 
...
the Firefox browser, including the \texttt{Web Developer / Network} tools within Firefox to
inspect the HTTP requests and responses. 

\begin{figure}[htb]
\begin{center}
\includegraphics [width=0.8\textwidth,natwidth=621,natheight=403]{xforge.jpg}
\end{center}
